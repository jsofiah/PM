...
class FilterSelector extends StatefulWidget {
  ...
  final void Function(Color selectedColor)
      onFilterChanged;

  final EdgeInsets padding;

  @override
  State<FilterSelector> createState() =>
...
class _FilterSelectorState
  ...
  static const _viewportFractionPerItem =
      1.0 / _filtersPerScreen;
  ...
  Color itemColor(int index) =>
      widget.filters[index % filterCount];
